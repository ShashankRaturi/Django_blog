...
from blog_users_app import views as users_app_view
...
urlpatterns = [
    ...
    # path('password-reset/done/' , auth_views.PasswordResetDoneView.as_view(template_name = 'blog_users_app/password_reset_done.html') , name = 'password_reset_done'),

    # path('password-reset-confirm/<uidb64>/<token>/' , auth_views.PasswordResetConfirmView.as_view(template_name = 'blog_users_app/password_reset_confirm.html') , name = 'password_reset_confirm'),
